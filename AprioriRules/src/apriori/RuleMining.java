 ...
 */
public class RuleMining extends Observable {


    public static void main(String[] args) throws Exception {
    	RuleMining ap = new RuleMining(args);
    }
    ...
    public  RuleMining(String[] args, Observer ob) throws Exception
    {
    	usedAsLibrary = true;
    	configure(args);
    	this.addObserver(ob);
     ...
     */
    public  RuleMining(String[] args) throws Exception
    {
        configure(args);
        go();
    }
